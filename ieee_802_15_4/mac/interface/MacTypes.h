...
typedef enum
{
    ...
    gMacTxOptionCSL_c               = 0x08,        /*!< CSL transmission is required */
    gMacTxOptionCsmaOff_c           = 0x10,        /*!< Disable CSMA-CA for this data Tx request.*/
    gMacTxOptionBhDevice_c          = 0x20,        /*!< Add device to BH table.*/
...
typedef PACKED_STRUCT macSuperframeSpec_tag
{
...
typedef PACKED_STRUCT gtsCharacteristics_tag
{
...
typedef PACKED_STRUCT macLinkOptions_tag
{
...
typedef PACKED_STRUCT macTimeslotTemplate_tag
{
    ...
    uint16_t macTsTimeslotLength;   /*!< The total length of the timeslot including any unused time after frame transmission and Acknowledgment, in �s */
