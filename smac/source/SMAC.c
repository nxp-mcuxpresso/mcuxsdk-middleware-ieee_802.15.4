 ...
 */
const char* mSmacVersionString = (char*)gSmacVerString_c;
...
const uint8_t TEST_KEY[ENC_BLOCK_SIZE] = { 0x2b, 0x7e, 0x15, 0x16, 0x28, 0xae, 0xd2, 0xa6, 0xab, 0xf7, 0x15, 0x88, 0x09, 0xcf, 0x4f, 0x3c };
// Use hardcoded DKEY for now (see KFOURWONE-311)
const uint8_t TEST_IV[ENC_BLOCK_SIZE]  = { 0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0a, 0x0b, 0x0c, 0x0d, 0x0e, 0x0f };
#if (defined(FSL_FEATURE_SOC_LTC_COUNT) && (FSL_FEATURE_SOC_LTC_COUNT > 0))
/* This key is the last round key of the expanded key used for encryption */
const uint8_t TEST_DKEY[ENC_BLOCK_SIZE] = { 0xd0, 0x14, 0xf9, 0xa8, 0xc9, 0xee, 0x25, 0x89, 0xe1, 0x3f, 0x0c, 0xc8, 0xb6, 0x63, 0x0c, 0xa6 };
#endif
...
)
{
  ...
  currentChannel = (channels_t)lMsg.msgData.getReq.PibAttributeValue;
...
#if !gUseSMACLegacy_c
/************************************************************************************
* SMACSetExtendedSrcAddress
*
* This function sets the extended source address so that PHY can perform filtering
*
************************************************************************************/
...
* SMACSetTxAutoAck
*
* This function enables/disables auto acknoledgement for Tx
*
************************************************************************************/

smacErrors_t SMACSetTxAutoAck(bool_t enable)
{
...
* SMACSetTxEnhAck
*
* This function enables/disables enhanced acknoledgement for Tx
*
************************************************************************************/

smacErrors_t SMACSetTxEnhAck(bool_t enable)
{
