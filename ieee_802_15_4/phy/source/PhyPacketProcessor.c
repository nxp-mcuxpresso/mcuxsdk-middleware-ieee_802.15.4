...
bitmask_chnk_t sw_saa_bitmask[SW_SAM_BITMASK_CHNK_NO(gPhySAPSize_d)];
...
{
#if defined(K32W1480_SERIES) || defined(MCXW72BD_cm33_core0_SERIES) || defined(MCXW72BD_cm33_core1_SERIES)
